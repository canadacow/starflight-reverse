...
emulate: src/emul/emul.c src/emul/call.c src/emul/findword.c src/emul/callstack.c cpu.o src/disasOV/global.c src/emul/graphics.cpp src/emul/fract.c patch.o
	$(CXX) $(CFLAGS) -DSTARFLT1 src/emul/emul.c src/emul/call.c src/emul/findword.c src/emul/callstack.c cpu.o src/disasOV/global.c src/emul/graphics.cpp src/emul/fract.c patch.o -o emulate

emulatesdl: src/emul/emul.c src/emul/call.c cpu.o src/emul/findword.c src/emul/callstack.c src/disasOV/global.c src/emul/graphics.cpp src/emul/fract.c
	$(CXX) $(CFLAGS) -DSTARFLT1 -DSDL src/emul/emul.c src/emul/call.c src/emul/findword.c src/emul/callstack.c cpu.o src/disasOV/global.c src/emul/graphics.cpp src/emul/fract.c -o emulatesdl -lSDL2

extractplanets1: src/extract/extractplanets.c src/emul/call.c src/emul/findword.c src/emul/callstack.c cpu.o src/disasOV/global.c src/emul/graphics.cpp src/emul/fract.c patch.o
	$(CC) $(CFLAGS) -DSTARFLT1 src/extract/extractplanets.c src/emul/call.c src/emul/findword.c src/emul/callstack.c cpu.o src/disasOV/global.c src/emul/graphics.cpp src/emul/fract.c patch.o -lpng -o extractplanets1

extractplanetsdata1: src/extract/extractplanetsdata.c src/emul/call.c src/emul/findword.c src/emul/callstack.c cpu.o src/disasOV/global.c src/emul/graphics.cpp src/emul/fract.c patch.o
	$(CC) $(CFLAGS) -DSTARFLT1 src/extract/extractplanetsdata.c src/emul/call.c src/emul/findword.c src/emul/callstack.c cpu.o src/disasOV/global.c src/emul/graphics.cpp src/emul/fract.c patch.o -o extractplanetsdata1
...
extractvessels1: src/extract/extractvessels.c src/emul/call.c src/emul/findword.c src/emul/callstack.c cpu.o src/disasOV/global.c src/emul/graphics.cpp src/emul/fract.c patch.o
	$(CC) $(CFLAGS) -DSDL -DSTARFLT1 src/extract/extractvessels.c src/emul/call.c src/emul/findword.c src/emul/callstack.c cpu.o src/disasOV/global.c src/emul/graphics.cpp src/emul/fract.c patch.o -o extractvessels1 -lSDL2

emulatecomm1: src/extract/emulatecomm.c src/emul/call.c src/emul/findword.c src/emul/callstack.c cpu.o src/disasOV/global.c src/emul/graphics.cpp src/emul/fract.c patch.o
	$(CC) $(CFLAGS) -DSTARFLT1 src/extract/emulatecomm.c src/emul/call.c src/emul/findword.c src/emul/callstack.c cpu.o src/disasOV/global.c src/emul/graphics.cpp src/emul/fract.c patch.o -o emulatecomm1
