...
public:
    struct FrameAttribs
    {
        ...
        const HLSL::LightAttribs * pLightAttribs = nullptr;
        const HLSL::CameraAttribs* pCameraAttribs = nullptr;
    ...
    struct CreateInfo
    {
        ...
        HLSL::AirScatteringAttribs ScatteringAttibs    = {};
    };
    ...
    void PrepareForNewFrame(FrameAttribs&                   FrameAttribs,
                            HLSL::EpipolarLightScatteringAttribs & PPAttribs);
...
private:
    ...
    HLSL::EpipolarLightScatteringAttribs m_PostProcessingAttribs;
    ...
    HLSL::AirScatteringAttribs m_MediaParams;
