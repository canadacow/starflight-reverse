...
const SamplerDesc SF_PBR_Renderer::CreateInfo::DefaultSampler = Sam_LinearWrap;
...
static const char* GetTextureAttribString(SF_PBR_Renderer::TEXTURE_ATTRIB_ID Id)
{
    static const std::array<const char*, SF_PBR_Renderer::TEXTURE_ATTRIB_ID_COUNT> TextureAttribStrings =
        []() {
            std::array<const char*, SF_PBR_Renderer::TEXTURE_ATTRIB_ID_COUNT> AttribStrings;
            AttribStrings[SF_PBR_Renderer::TEXTURE_ATTRIB_ID_BASE_COLOR]            = "BaseColor";
            AttribStrings[SF_PBR_Renderer::TEXTURE_ATTRIB_ID_NORMAL]                = "Normal";
            AttribStrings[SF_PBR_Renderer::TEXTURE_ATTRIB_ID_PHYS_DESC]             = "PhysicalDescriptor";
            AttribStrings[SF_PBR_Renderer::TEXTURE_ATTRIB_ID_METALLIC]              = "Metallic";
            AttribStrings[SF_PBR_Renderer::TEXTURE_ATTRIB_ID_ROUGHNESS]             = "Roughness";
            AttribStrings[SF_PBR_Renderer::TEXTURE_ATTRIB_ID_OCCLUSION]             = "Occlusion";
            AttribStrings[SF_PBR_Renderer::TEXTURE_ATTRIB_ID_EMISSIVE]              = "Emissive";
            AttribStrings[SF_PBR_Renderer::TEXTURE_ATTRIB_ID_CLEAR_COAT]            = "ClearCoat";
            AttribStrings[SF_PBR_Renderer::TEXTURE_ATTRIB_ID_CLEAR_COAT_ROUGHNESS]  = "ClearCoatRoughness";
            AttribStrings[SF_PBR_Renderer::TEXTURE_ATTRIB_ID_CLEAR_COAT_NORMAL]     = "ClearCoatNormal";
            AttribStrings[SF_PBR_Renderer::TEXTURE_ATTRIB_ID_SHEEN_COLOR]           = "SheenColor";
            AttribStrings[SF_PBR_Renderer::TEXTURE_ATTRIB_ID_SHEEN_ROUGHNESS]       = "SheenRoughness";
            AttribStrings[SF_PBR_Renderer::TEXTURE_ATTRIB_ID_ANISOTROPY]            = "Anisotropy";
            AttribStrings[SF_PBR_Renderer::TEXTURE_ATTRIB_ID_IRIDESCENCE]           = "Iridescence";
            AttribStrings[SF_PBR_Renderer::TEXTURE_ATTRIB_ID_IRIDESCENCE_THICKNESS] = "IridescenceThickness";
            AttribStrings[SF_PBR_Renderer::TEXTURE_ATTRIB_ID_TRANSMISSION]          = "Transmission";
            AttribStrings[SF_PBR_Renderer::TEXTURE_ATTRIB_ID_THICKNESS]             = "Thickness";
            static_assert(SF_PBR_Renderer::TEXTURE_ATTRIB_ID_COUNT == 17, "Not all texture names are initialized");
            return AttribStrings;
        }();
    return TextureAttribStrings[Id];
}

static std::string GetTextureShaderName(SF_PBR_Renderer::TEXTURE_ATTRIB_ID Id)
{
    return std::string{"g_"} + GetTextureAttribString(Id) + "Map";
}

static std::string GetTextureAttribIdString(SF_PBR_Renderer::TEXTURE_ATTRIB_ID Id)
{
    return std::string{GetTextureAttribString(Id)} + "TextureAttribId";
}

static std::string GetTextureIdString(SF_PBR_Renderer::TEXTURE_ATTRIB_ID Id)
{
    return std::string{GetTextureAttribString(Id)} + "TextureId";
}

std::string SF_PBR_Renderer::GetPSOFlagsString(PSO_FLAGS Flags)
{
    std::string FlagsStr;
...
const char* SF_PBR_Renderer::GetAlphaModeString(ALPHA_MODE AlphaMode)
{
    switch (AlphaMode)
    {
...
SF_PBR_Renderer::~SF_PBR_Renderer()
{
...
void SF_PBR_Renderer::PrecomputeBRDF(IDeviceContext* pCtx,
...
void SF_PBR_Renderer::PrecomputeCubemaps(IDeviceContext* pCtx,
...
void SF_PBR_Renderer::CreateSignature()
{
    ...
    SignatureDesc
        ...
        .AddResource(SHADER_TYPE_VS_PS | SHADER_TYPE_DOMAIN | SHADER_TYPE_HULL, "cbFrameAttribs", SHADER_RESOURCE_TYPE_CONSTANT_BUFFER, SHADER_RESOURCE_VARIABLE_TYPE_MUTABLE)
        .AddResource(SHADER_TYPE_VS_PS | SHADER_TYPE_DOMAIN, "cbPrimitiveAttribs", SHADER_RESOURCE_TYPE_CONSTANT_BUFFER, SHADER_RESOURCE_VARIABLE_TYPE_MUTABLE)
        .AddResource(SHADER_TYPE_VS_PS | SHADER_TYPE_DOMAIN, "cbHeightmapAttribs", SHADER_RESOURCE_TYPE_CONSTANT_BUFFER, SHADER_RESOURCE_VARIABLE_TYPE_MUTABLE)
        .AddResource(SHADER_TYPE_VS_PS | SHADER_TYPE_DOMAIN, "g_Heightmap", SHADER_RESOURCE_TYPE_TEXTURE_SRV, SHADER_RESOURCE_VARIABLE_TYPE_MUTABLE)
        .AddResource(SHADER_TYPE_VS_PS | SHADER_TYPE_DOMAIN, "instanceBuffer", SHADER_RESOURCE_TYPE_BUFFER_SRV, SHADER_RESOURCE_VARIABLE_TYPE_MUTABLE)
        .AddResource(SHADER_TYPE_VS_PS | SHADER_TYPE_DOMAIN, "cbTerrainAttribs", SHADER_RESOURCE_TYPE_CONSTANT_BUFFER, SHADER_RESOURCE_VARIABLE_TYPE_MUTABLE)
        .AddResource(SHADER_TYPE_VS_PS | SHADER_TYPE_DOMAIN, "g_WaterHeightMap", SHADER_RESOURCE_TYPE_TEXTURE_SRV, SHADER_RESOURCE_VARIABLE_TYPE_DYNAMIC)
        ...
        m_Settings.GetStaticShaderTextureIds == nullptr)
    {
        ...
        m_StaticShaderTextureIds->fill(decltype(SF_PBR_Renderer::InvalidMaterialTextureId){SF_PBR_Renderer::InvalidMaterialTextureId});
    }
...
void SF_PBR_Renderer::CreateCustomSignature(PipelineResourceSignatureDescX&& SignatureDesc)
{
...
ShaderMacroHelper SF_PBR_Renderer::DefineMacros(const PSOKey& Key) const
{
...
#undef ADD_PSO_FLAG_MACRO
    ...
    MaterialTextureIds.fill(decltype(SF_PBR_Renderer::InvalidMaterialTextureId){InvalidMaterialTextureId});
    if (m_Settings.ShaderTexturesArrayMode == SHADER_TEXTURE_ARRAY_MODE_STATIC)
    {
    ...
    int MaxIndex = -1;
    ProcessTexturAttribs(PSOFlags, [&](int CurrIndex, SF_PBR_Renderer::TEXTURE_ATTRIB_ID AttribId) //
                         {
...
void SF_PBR_Renderer::GetVSInputStructAndLayout(PSO_FLAGS         PSOFlags,
...
std::string SF_PBR_Renderer::GetVSOutputStruct(PSO_FLAGS PSOFlags, bool UseVkPointSize, bool UsePrimitiveId)
{
    // struct VSOutput
    // {
...
std::string SF_PBR_Renderer::GetPSOutputStruct(PSO_FLAGS PSOFlags)
{
    // struct PSOutput
    // {
...
void SF_PBR_Renderer::CreatePSO(PsoHashMapType&             PsoHashMap,
...
IPipelineState* SF_PBR_Renderer::GetPSO(PsoHashMapType&             PsoHashMap,
                                     const GraphicsPipelineDesc& GraphicsDesc,
                                     const PSOKey&               Key,
...
void SF_PBR_Renderer::SetInternalShaderParameters(HLSL::PBRRendererShaderParameters& Renderer)
{
