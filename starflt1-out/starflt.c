...
//           W4EDD  codep:0x1d29 wordp:0x4edd size:0x0025 C-string:'W4EDD'
...
//          RECADD  codep:0x718d wordp:0x718d size:0x00ab C-string:'RECADD'
...
// TREJECT/TACCEPT  codep:0x1d29 wordp:0x8538 size:0x00cb C-string:'TREJECT_slash_TACCEPT'
...
const unsigned short int pp_W4EDD = 0x4edd; // W4EDD size: 37
// {0x00, 0x22, 0x11, 0x99, 0x44, 0x66, 0x88, 0xaa, 0x55, 0x77, 0xbb, 0x33, 0xee, 0xcc, 0xdd, 0xff, 0x4c, 0x22, 0x4f, 0x06, 0xaf, 0x21, 0xfa, 0x1b, 0xe8, 0x51, 0xc7, 0x92, 0x0c, 0xdb, 0x4e, 0x72, 0x0f, 0x92, 0x0c, 0x90, 0x16}
...
// ================================================
// 0x16b4: db 0xd2 0x02 0x00 0x15 0x00 0x80 0x05 0x00 0xca 0x2d 0x38 0xd3 0xca 0x2d 0xa8 0xd4 0xf1 0x16 0xf1 0x16 0xcd 0x21 0xc3 '         -8  -       ! '
...
// 0x270e: db 0x8b 0x5d 0x1a 0x8a 0x45 0x1c 0x00 0xd8 0xb3 0x50 0xf6 0xe3 0x8a 0xdf 0x8a 0x7d 0x1d 0x00 0xfb 0x28 0xff 0x01 0xd8 0xc3 ' ]  E    P     }   (    '
...
// ================================================
// 0x2f2a: WORD '{LXCHG}' codep=0x1d29 wordp=0x2f36
// ================================================
// 0x2f36: db 0x51 0x26 0x8b 0x0f 0x87 0xd8 0x26 0x87 0x0f 0x87 0xd8 0x26 0x89 0x0f 0x59 0xc3 'Q&    &    &  Y '
...
// ================================================
// 0x49c8: WORD 'W49CA' codep=0x1d29 wordp=0x49ca
// ================================================
// 0x49ca: db 0x51 0x26 0x8a 0x0f 0x87 0xd8 0x26 0x86 0x0f 0x87 0xd8 0x26 0x88 0x0f 0x59 0xc3 'Q&    &    &  Y '
...
// ================================================
// orphan
// 0x4edd: db 0x00 0x22 0x11 0x99 0x44 0x66 0x88 0xaa 0x55 0x77 0xbb 0x33 0xee 0xcc 0xdd 0xff 0x4c 0x22 0x4f 0x06 0xaf 0x21 0xfa 0x1b 0xe8 0x51 0xc7 0x92 0x0c 0xdb 0x4e 0x72 0x0f 0x92 0x0c 0x90 0x16 ' "  Df  Uw 3    L"O  !   Q    Nr     '
...
// 0x71db: db 0xdd 0x71 0x58 0x3d 0x90 0x00 0x78 0x0c 0x8b 0x1e 0x5e 0x53 0x83 0xc3 0x03 0x2d 0x90 0x00 0xeb 0x24 0x3d 0x60 0x00 0x78 0x0c 0x8b 0x1e 0x5e 0x53 0x83 0xc3 0x02 0x2d 0x60 0x00 0xeb 0x13 0x3d 0x30 0x00 0x78 0x0a 0x8b 0x1e 0x5e 0x53 0x43 0x2d 0x30 0x00 0xeb 0x04 0x8b 0x1e 0x5e 0x53 0xb9 0x15 0x00 0xf7 0xe9 0x50 0x53 0xad 0x8b 0xd8 0xff 0x27 0x4c 0x22 0x4f 0x06 0xaf 0x21 0xfa 0x1b 0xe8 0x1f 0xa4 0x92 0x0c 0xf2 0x0e 0xdb 0x71 0x1f 0x6e 0x72 0x0f 0x72 0x0f 0x90 0x16 ' qX=  x   ^S   -   $=` x   ^S   -`   =0 x   ^SC-0     ^S     PS    'L"O  !          q nr r   '
...
// ================================================
// 0x8536: WORD 'TREJECT/TACCEPT' codep=0x1d29 wordp=0x8538
// ================================================
// orphan
// 0x8538: db  '    UWV  2  6 V > V .RW   V3  ; y    ; _W~     ; 8Wy    ; EW~       "     3      V     V^_] ) SUVW   W 6 W . W > W > V u       ,W+   +     +         ,W > V u   + ; 8Wy    ; EW~    ; RWy    ; _W~    _^][ '

// ================================================
// 0x8603: WORD 'CLIP' codep=0x1d29 wordp=0x8605
// ================================================
// 0x8605: db  '   V   6 V > V   V . V 6 V > V   V . V   V > V u0     W D    W     W" (Wu      W F E   V     IC #I       W+              W T    W+ A     W D    W     WC  (W"  W"& W: t\QP3   ,W > V u ;  Wt A;  Wt      3   ;  Wt A;  Wt      3  > V u A  t               F E   VXY  u      W V E   V        W   W   W   W   W   WIt  K    V   V   V   V   V   V   V   V   V   V 6 V > V   V . V '
...
// ================================================
// 0x87df: WORD 'SCANCON' codep=0x1d29 wordp=0x87e1
// ================================================
// 0x87e1: db  ' 6 W   W   WQ; y    W   W   W   W   W   W     W+  W}            W+  W  ; }             =                         W > W3 3        W              ~       J}    W   W '
...
// ================================================
// 0x8c35: WORD 'SET6845' codep=0x1d29 wordp=0x8c41
// ================================================
// 0x8c41: db 0xb9 0x0e 0x00 0x32 0xe4 0x8a 0xc4 0xee 0x42 0xac 0xee 0x80 0xc4 0x01 0x4a 0xe2 0xf4 0xc3 '   2    B     J   '
...
// ================================================
// 0x8c9a: WORD '>HGRAPH' codep=0x1d29 wordp=0x8ca6
// ================================================
// 0x8ca6: db 0xba 0xb8 0x03 0xb0 0x02 0xee 0xb0 0x01 0xba 0xbf 0x03 0xee 0xba 0xb4 0x03 0xbe 0x74 0x8c 0xe8 0x86 0xff 0xba 0xb8 0x03 0xb0 0x0a 0xee 0xc3 '                t           '

// ================================================
// 0x8cc2: WORD '>HTEXT' codep=0x1d29 wordp=0x8ccd
// ================================================
// 0x8ccd: db 0xba 0xb8 0x03 0xb0 0x20 0xee 0xb0 0x00 0xba 0xbf 0x03 0xee 0xba 0xb4 0x03 0xbe 0x8c 0x8c 0xe8 0x5f 0xff 0xba 0xb8 0x03 0xb0 0x28 0xee 0xc3 '                   _     (  '

// ================================================
// 0x8ce9: WORD 'W8CEB' codep=0x1d29 wordp=0x8ceb
// ================================================
// 0x8ceb: db 0xb8 0x8d 0x00 0xcd 0x10 0xba 0xce 0x03 0xb0 0x01 0xb4 0x0f 0xee 0x42 0x86 0xc4 0xee 0xc3 '             B    '
...
// ================================================
// 0x8d3d: WORD '>TANDY' codep=0x1d29 wordp=0x8d48
// ================================================
// 0x8d48: db 0xb0 0x03 0xba 0xda 0x03 0xee 0xb0 0x10 0xba 0xde 0x03 0xee 0xb0 0x01 0xba 0xda 0x03 0xee 0xb0 0x0f 0xba 0xde 0x03 0xee 0xbb 0x27 0x0a 0xc3 '                         '  '
...
// ================================================
// 0x8e26: WORD 'COPYLIN' codep=0x1d29 wordp=0x8e32
// ================================================
// 0x8e32: db 0xb0 0x05 0xb4 0x01 0xba 0xce 0x03 0xee 0x42 0x86 0xc4 0xee 0xf3 0xa4 0xb0 0x05 0xb4 0x00 0xba 0xce 0x03 0xee 0x42 0x86 0xc4 0xee 0xc3 '        B             B    '
...
// ================================================
// 0x8f3b: WORD 'W8F3D' codep=0x1d29 wordp=0x8f3d
// ================================================
// orphan
// 0x8f3d: db 0x06 0x57 0xb4 0x0f 0xba 0xc4 0x03 0xb0 0x02 0xee 0x42 0x86 0xc4 0xee 0xba 0xce 0x03 0xb0 0x01 0xb4 0x0f 0xee 0x42 0x86 0xc4 0xee 0xba 0xce 0x03 0x8a 0x26 0xf2 0x55 0xb0 0x00 0xee 0x42 0x86 0xc4 0xee 0x4a 0xb4 0xff 0xb0 0x08 0xee 0x42 0x86 0xc4 0xee 0x8b 0x06 0x48 0x56 0x8e 0xc0 0xbf 0x00 0x00 0x8b 0x0e 0x56 0x56 0xf3 0xaa 0x5f 0x07 0xc3 ' W        B           B       & U   B   J     B     HV       VV  _  '
...
// ================================================
// 0x9300: WORD '(PLOT)' codep=0x1d29 wordp=0x930b
// ================================================
// 0x930b: db 0x8f 0x06 0x63 0x56 0x5a 0x58 0xd1 0xe2 0x03 0x16 0x3a 0x56 0x52 0x50 0x25 0x03 0x00 0xd1 0xe0 0xbb 0xcf 0x92 0x03 0xd8 0x8b 0x17 0x58 0xd1 0xe8 0xd1 0xe8 0x5b 0x03 0x07 0x8b 0xd8 0x06 0x8b 0x0e 0x48 0x56 0x8e 0xc1 0x8b 0xc2 0x86 0xc4 0xba 0xce 0x03 0xb0 0x08 0xee 0x42 0x86 0xc4 0xee 0xba 0xce 0x03 0x8a 0x26 0xf2 0x55 0xb0 0x00 0xee 0x42 0x86 0xc4 0xee 0x26 0x8a 0x07 0x26 0x88 0x07 0x07 0xff 0x36 0x63 0x56 0xc3 '  cVZX    :VRP%           X    [       HV            B       & U   B   &  &    6cV '
